...
def generate_lyot_psf_grid(inst, source_spectrum=None, nr=12, ntheta=4, log_rscale=True, rmin=0.05, rmax=3.5,
                            normalize='exit_pupil', nlambda=None, shift=None, osamp=2, fov_pixels=201, show_progress=True):
    """
    ...
    for psf_offset in iterator:
        ...
        psfs_nodist.append(stpsf.distortion.apply_rotation(fits.HDUList([psf_hdul[0], psf_hdul[0]]), crop=True)[1].data)
